...
import CaptchaBox from "../../components/CaptchaBox"; // ✅ Reusable Captcha
...
const SearchTaxPayer = () => {
  ...
  useEffect(() => {
    // initial captcha is generated by CaptchaBox
  }, []);
  ...
  const handleSearch = () => {
    ...
    if (!match) {
      ...
      toast.success("✅ GSTIN matched successfully");
      setResult(match);
    }
  };
    ...
    <>
      ...
      <div className="taxpayer-container">
        <div className="form-section mt-2">
          ...
          />
          <div style={{paddingTop : '10px',marginTop:'7px'}}>
