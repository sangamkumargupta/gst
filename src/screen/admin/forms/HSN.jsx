...
const HSN = () => {
  const [selectedForm] = useState("HSN");
  ...
  useEffect(() => {
    setListData([
      {
        hsn: "Goods", // HSN b2b (dropdown value from supplyType)
        description: "Steel Rods", // Description
        uqc: "KGS", // UQC (dropdown value from uqc)
        total_quantity: 100, // Total Quantity
        total_value: 50000, // Total Value (₹)
        items: [
          {
            rate: "8",
            taxable_value: "10000",
