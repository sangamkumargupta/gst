...
const AT = () => {
  const [selectedForm] = useState("AT");
  ...
  useEffect(() => {
    setListData([
      {
        place_of_supply: "Maharashtra", // Place Of Supply
        applicable_tax_rate: 18, // Applicable % of Tax Rate / Rate
        gross_advance_received: "15000", // Gross Advance Received (₹)
        items: [
          {
            rate: "8",
            taxable_value: "10000",
