...
const EXP = () => {
  const [selectedForm] = useState("EXP");
  ...
  useEffect(() => {
    setListData([
      {
        export_type: "With Payment", // Export Type ("With Payment" or "Without Payment")
        invoice_number: "INV001", // Invoice Number
        invoice_date: "2025-07-21", // Invoice Date
        invoice_value: "15000", // Invoice Value (₹)
        port_code: "INBOM1", // Port Code (example: Mumbai port)
        shipping_bill_number: "SB1234567", // Shipping Bill Number (example value)
        shipping_bill_date: "2025-07-20", // Shipping Bill Date (example value)
        items: [
          {
            rate: "8",
            taxable_value: "10000",
    ...
    <div className="form-container">
      ...
      {activeTabForm === "form" ? (
        ...
        <div>
          ...
          {selectedDetailRow?.items &&
            Array.isArray(selectedDetailRow.items) && (
              <div
