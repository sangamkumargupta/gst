...
const ECOA = () => {
  const [selectedForm] = useState("ecoa");
...
useEffect(() => {
  setListData([
    {
      nature_of_supply: "Liable to collect tax u/s 52(TCS)",        // Matches dropdownOptions.natureOfSupply
      financial_year: "2024-25",              // Matches dropdownOptions.financialYear
      original_month_quarter: "July",         // Matches dropdownOptions.months (or quarters)
      original_gstin_ecom: "27ABCDE1234F1Z5", // Original GSTIN of E-Commerce Operator
      revised_gstin_ecom: "27WXYZ5678L9P2",   // Revised GSTIN (optional, can be "")
      ecom_operator_name: "ABC Pvt Ltd",      // Name of the E-Commerce Operator
      revised_net_value: "15000",             // Net Value of Supplies
    },
  ]);
}, []);
