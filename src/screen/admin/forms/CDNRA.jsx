...
const CDNRA = () => {
  const [selectedForm] = useState("cdnra");
...
useEffect(() => {
  setListData([
    {
      gstin_uin: "22AAAAA0000A1Z5",        // GSTIN/UIN of Recipient
      receiver_name: "ABC Pvt Ltd",       // Receiver Name
      original_note_number: "NOTE001",    // Original Note Number
      original_note_date: "2025-07-21",   // Original Note Date
      revised_note_number: "NOTE002",     // Revised Note Number (optional)
      revised_note_date: "2025-07-25",    // Revised Note Date (optional)
      note_type: "C",                // Credit/Debit (must exist in dropdownOptions.noteType)
      pos: "19-Lakshadweep",                 // Place Of Supply (dropdownOptions.placeOfSupply)
      reverse_charge: "Y",               // Reverse Charge (dropdownOptions.reverseCharge)
      note_supply_type: "Regular B2B",    // Supply Type (dropdownOptions.invoiceType or new dropdown)
      note_value: "15000",                // Note Value
      applicable_tax_rate:"65.00",        // Tax Rate (dropdownOptions.taxrate)
    },
  ]);
}, []);
