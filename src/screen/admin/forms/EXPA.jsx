...
const EXPA = () => {
  const [selectedForm] = useState("expa");
  ...
  useEffect(() => {
    setListData([
      {
        export_type: "WOPAY", // Sample option from dropdownOptions.exportType
        original_invoice_number: "ORIGEXP001",
        original_invoice_date: "2025-07-05",
        revised_invoice_number: "REVEXP001",
        revised_invoice_date: "2025-07-15",
        invoice_value: "250000",
        port_code: "MUM001",
        shipping_bill_number: "SB12345",
        shipping_bill_date: "2025-07-18",
      },
    ]);
  }, []);
