...
const GSTR9_9 = () => {
  const [selectedForm] = useState("NINE");
              ...
              <table className="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th colSpan="7" style={{ textAlign: "center" }}>Paid Through ITC(₹)</th>
                  ...
                  {formData.tables?.map((row, rowIndex) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* sr_no_to */}
                        {/* {row.particular !== "(A) Total Refunds Claimed" ? ( */}
                          <td>
                            <input
                              type="text"
                              inputMode="numeric"
                              ...
                              disabled = {row.particular === "Integrated Tax" || row.particular === "Central Tax" || row.particular === "State/UT Tax" || row.particular === "Cess" || row.particular === "Interest" || row.particular === "Penalty" || row.particular === "Late Fees" || row.particular === "Others"}
                              placeholder="₹ 0.00"
                              onChange={(e) => {
                                const raw = e.target.value.replace(/,/g, "").replace(/\D/g, "");
                        ...
                        {row.particular !== "Integrated Tax" && row.particular !== "Central Tax" && row.particular !== "State/UT Tax" ? (
                            <td style={{ backgroundColor: "#E9ECEF", border: "none" }}>  </td>
                        ):(
                          <td>
                            <input
                              ...
                              disabled = {row.particular === "Integrated Tax" || row.particular === "Central Tax" || row.particular === "State/UT Tax"}
                              placeholder="₹ 0.00"
                              onChange={(e) => {
                                const raw = e.target.value.replace(/,/g, "").replace(/\D/g, "");
                        ...
                        {/* cancelled */} 
                         {row.particular !== "Integrated Tax" && row.particular !== "Central Tax"   ? (
                            <td style={{ backgroundColor: "#E9ECEF", border: "none" }}>  </td>
                        ):(
                          <td>
                            <input
                        ...
                        {/* net_issued */}
                         {row.particular !== "Integrated Tax"  && row.particular  && row.particular !== "State/UT Tax" ? (
                            <td style={{ backgroundColor: "#E9ECEF", border: "none" }}>  </td>
                        ):(
                          <td>
                            <input
                        ...
                        {/* net_issued */}
                         {row.particular === "Integrated Tax" || row.particular === "Central Tax" || row.particular === "State/UT Tax"  || row.particular === "Interest" || row.particular === "Penalty" || row.particular === "Late Fees" || row.particular === "Others" ?(
                            <td style={{ backgroundColor: "#E9ECEF", border: "none" }}>  </td>
                        ):(
                            <td>
                              <input
                                ...
                                className="form-control"
                                disabled 
                                value={formatNumber(row.interest)}
                                placeholder="₹ 0.00"
                                readOnly
                              />
                            </td>
