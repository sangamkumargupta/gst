...
const GSTR9_15 = () => {
  const [selectedForm] = useState("FIFTEEN");
                  ...
                  {formData.tables?.map((row, rowIndex) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* net_issued */}
                        {row.particular !== "(A) Total Refunds Claimed" && row.particular !== "(B) Total Refunds sanctioned" && row.particular !== "(C) Total Refunds rejected" &&  row.particular !==  "(D) Total Refunds pending" ? (
                            <td>
                              <input
                                type="text"
                                className="form-control"
                        ...
                        {row.particular !== "(A) Total Refunds Claimed" && row.particular !== "(B) Total Refunds sanctioned" && row.particular !== "(C) Total Refunds rejected" &&  row.particular !==  "(D) Total Refunds pending" ? (
                          <td>
                            <input
                              type="text"
                              className="form-control"
                              value={formatNumber(row.penalty)}
                              placeholder="₹ 0.00"
                              readOnly
                            />
                          </td>
                        ...
                        {row.particular !== "(A) Total Refunds Claimed" && row.particular !== "(B) Total Refunds sanctioned" && row.particular !== "(C) Total Refunds rejected" &&  row.particular !==  "(D) Total Refunds pending" ? (
                          <td>
                            <input
                              type="text"
                              className="form-control"
                              value={formatNumber(row.late_fee_others)}
                              placeholder="₹ 0.00"
                              readOnly
                            />
                          </td>
