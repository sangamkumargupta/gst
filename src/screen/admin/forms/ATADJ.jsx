...
const ATADJ = () => {
  const [selectedForm] = useState("ATADJ");
  ...
  useEffect(() => {
    setListData([
      {
        atadj_place_of_supply: "Maharashtra", // Place Of Supply
        atadj_applicable_percent_tax_rate: "18", // Applicable % of Tax Rate
        atadj_rate: "18", // Rate
        atadj_gross_advance_adjusted: "10000", // Gross Advance Adjusted
        atadj_cess_amount: "500", // Cess Amount
        items: [
          {
            rate: "8",
            taxable_value: "10000",
