...
const GSTR4AB2BA = forwardRef((props, ref) => {

  const data = [
    {
      period: "Apr-Jun 25",
      originalInvoiceNumber: "799901",
...
const exportToExcel = () => {
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "GSTR-4A B2BA");
  XLSX.writeFile(workbook, "GSTR4A-B2BA.xlsx");
};
