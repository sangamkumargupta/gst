...
const GSTR4AB2B = forwardRef((props, ref) => {
  const data = [
    {
      period: "Apr-Jun 25",
  ...
  //   XLSX.utils.book_append_sheet(workbook, worksheet, "GSTR-4A B2B");
  //   XLSX.writeFile(workbook, "GSTR4A-B2B.xlsx");
  // };
