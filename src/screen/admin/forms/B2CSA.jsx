...
const B2CSA = () => {
  const [selectedForm] = useState("b2csa");
  ...
  useEffect(() => {
    setListData([
      {
        financial_year: "2024-25", // Must be a valid option from dropdownOptions.financialYear
        original_month: "January", // Must be a valid option from dropdownOptions.months
        pos: "19-Lakshadweep", // Must match dropdownOptions.placeOfSupply
        supply_type: "OE", // Must match dropdownOptions.b2csType
        applicable_tax_rate: "65.00", // Must match dropdownOptions.taxrate
        rate: "65.00", // Example rate
        taxable_value: "15000", // Taxable value
        cess_amount: "200", // Optional (can be empty)
        ecommerce_gstin: "27ABCDE1234F1Z5", // Optional (can be empty)
      },
    ]);
  }, []);
