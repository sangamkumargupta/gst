...
const CDNURA = () => {
  const [selectedForm] = useState("cdnura");
  ...
  useEffect(() => {
    setListData([
      {
        ur_type: "B2CL", // Matches dropdownOptions.urType
        ...
        note_type: "C", // Matches dropdownOptions.noteType
        pos: "19-Lakshadweep", // Matches dropdownOptions.placeOfSupply
        note_value: "15000", // Note Value
        applicable_tax_rate: "65.00", // Matches dropdownOptions.taxrate
      },
    ]);
  }, []);
