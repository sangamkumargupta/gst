...
import { forms } from "../../../forms/formConfig.js";
import "../../../assets/css/formcss.css";
import { toast, ToastContainer } from "react-toastify";
import ReusableFormInputTable from "../../../components/ReusableFormInputTable.jsx";
...
const EXEMPTA = () => {
  const [selectedForm] = useState("exempta");
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    setListData([
      {
        exempt_description: "Outward Supplies to Composition Dealer", // Description
        exempt_nil_rated: "5000", // Nil Rated Supplies
        exempt_exempted_other: "3000", // Exempted (other than nil rated/non-GST)
        exempt_non_gst: "2000", // Non-GST Supplies
      },
    ]);
  }, []);
