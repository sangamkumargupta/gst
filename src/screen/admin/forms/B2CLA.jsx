...
const B2CLA = () => {
  const [selectedForm] = useState("b2cla");
    ...
    setListData([
      {
        ...
        original_invoice_date: "2025-07-10",
        original_pos: "19-Lakshadweep",
        revised_invoice_number: "REV001",
        revised_invoice_date: "2025-07-20",
        invoice_value: "15000",
        tax_rate: "65.00",
        ecommerce_gstin: "27ABCDE1234F1Z5",
      },
    ]);
  }, []);
    ...
    <div className="form-container">
      ...
      {activeTabForm === "form" ? (
        <form>
          ...
          <div className="form-buttons mt-4 d-flex">
            <Button
              label={updateLabel}
              type="button"
              variant="success"
